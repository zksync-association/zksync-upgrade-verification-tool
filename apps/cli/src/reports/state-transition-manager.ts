...
const PROXY_IMPLEMENTATION_STORAGE_POS = "0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc";
...
export class StateTransitionManager {
  ...
  static async create(proxyAddress: Address, rpc: RpcClient, explorer: BlockExplorerClient): Promise<StateTransitionManager> {
  ...
  async allHyperchainIds(rpc: RpcClient): Promise<bigint[]> {
    return rpc.contractRead(this.address, "getAllHyperchainChainIDs", this.abi.raw, z.array(z.bigint()));
  }
