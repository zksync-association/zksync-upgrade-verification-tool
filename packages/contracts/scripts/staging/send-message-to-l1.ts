...
const abi = [
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "bytes32", name: "_bytecodeHash", type: "bytes32" }],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "bytes", name: "_message", type: "bytes" },
    ],
    name: "L1MessageSent",
    type: "event",
  },
  ...
  {
    inputs: [{ internalType: "bytes", name: "_totalL2ToL1PubdataAndStateDiffs", type: "bytes" }],
  ...
  {
    inputs: [{ internalType: "bytes32", name: "_bytecodeHash", type: "bytes32" }],
  ...
  },
  {
    ...
    name: "sendL2ToL1Log",
    outputs: [{ internalType: "uint256", name: "logIdInMerkleTree", type: "uint256" }],
    stateMutability: "nonpayable",
    type: "function",
  },
  {
...
async function main() {
  const contract = new Contract("0x0000000000000000000000000000000000008008", abi, getZkWallet());
