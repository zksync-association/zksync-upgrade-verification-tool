...
export const ALL_COUNCIL_INDEXES = [
  DERIVATION_INDEXES.FIRST_COUNCIL,
  ...range(DERIVATION_INDEXES.SECOND_COUNCIL, COUNCIL_SIZE - 1),
];
export const ALL_GUARDIAN_INDEXES = [
  DERIVATION_INDEXES.FIRST_GUARDIAN,
  ...range(DERIVATION_INDEXES.SECOND_GUARDIAN, GUARDIANS_SIZE - 1),
];
