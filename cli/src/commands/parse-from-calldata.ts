...
//
// // @ts-ignore
// export async function parseFromCalldata(
//   ethscanKey: string,
...
//   }
//
//   const { data } = upgrade.transactions.governanceOperation.calls[0];
//
//   const diamond = await ZkSyncEraState.create(network, l1Client, l1Abis, rpc);
//
